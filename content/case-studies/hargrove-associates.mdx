...
The firm sees each submission with a score, a plain-language reason, and a recommended next action. Intake calls run shorter because the attorney already knows what they're walking into.
