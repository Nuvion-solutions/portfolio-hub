...
results:
  - "Complex technology communicated visually in under 3 seconds — enterprise buyers understand the product before reading a word"
  - "Live product demo on the homepage converts skeptics without a sales call or Calendly link"
  - "Differentiated brand identity that sets the product apart from hundreds of generic SaaS competitors"
  - "Investor-ready web presence that communicates scale, vision, and execution ability"
...
<QuoteCard
  quote="The hero alone closed two enterprise pilots before we'd written a single line of sales copy. People kept forwarding the URL with the message: 'this is what our AI infra should feel like.'"
  name="Demo Founder"
  role="CEO, NEXUS (Simulated Testimonial)"
/>
